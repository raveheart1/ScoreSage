...
def get_car_data(session_key, driver_number):
    ...
    try:
        ...
        print(f"Error fetching car data from API: {e}")
        return None
        ...
        for row in csv_reader:
            ...
            if session_key:
                ...
                for driver in drivers:
                    ...
                    if car_data:
                        write_csv(car_data, driver_folder, f"car_data_{session_name}.csv")
                    else:
                        print(f"No car data for driver {driver_name} in session {session_name}.")
            else:
